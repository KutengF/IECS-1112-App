...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    Context context;
    String removeUrl = "http://192.168.0.161/food-delivery-application/fooddeliveryapp/public/api/users/cart/remove";
    String addUrl = "http://192.168.0.161/food-delivery-application/fooddeliveryapp/public/api/users/cart/add";
